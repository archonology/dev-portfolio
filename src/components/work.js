const work = [
    ...
    },
    {
        ...
        employer: "Freelance",
        dates: "12/22/2022 - present",
        location: "Minnesota",
        status: "present",
        summary: "Using ReactJS, MongoDB, Express, and Node.js (MERN Stack), I designed and built a Single Page Application for a client that doubles as a Content Management System (CMS) for admin users. All data in the website can be created, updated, and deleted by approved admin users.",
        accomplishments: [
            "Implemented a double Web Token enviroment for admin and users.",
    ...
    },
    {
        ...
        location: "Grand Marais, MN",
        status: "past",
        summary: "Led in the community as a child protection and family services case manager for 5 years. Handled emergency responses, consultation, case planning, court case management, direct support services, data management, data monitoring, and community engagement in a fast paced setting with deep needs for record keeping and managing the integrity of data.",
        accomplishments: [
            "State recognized to have veteran social worker status",
            "County Board recognition for excellence in the field",
            "Increased successful family reunifications by 60% between 2019-2022."
        ],
