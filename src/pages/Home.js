  ...
  return (
    <>
      ...
      >
        ...
        experiences to draw from. His unconventional path through so many facets
        of work, the world, and society gives him a unique set of skills in
        intuition, compassion, communication, and big-thinking to navigate both
        ...
        <span className="homeLinks" style={{}}>
          ...
          <a href="https://reedmeher.com/" target="_blank" rel="nonreferrer">
